package com.unknownshop.swing.combobox;
...
public class ComboboxWhite<E> extends JComboBox<E> {
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        private ComboboxWhite combo;

        public ComboUI(ComboboxWhite combo) {
            this.combo = combo;
            ...
            addPopupMenuListener(new PopupMenuListener() {
                ...
                public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                    arrowButton.setBackground(new Color(102, 102, 102));
                }
...
//                    sb.setForeground(new Color(51, 51, 51));
//                    scroll.setVerticalScrollBar(sb);
                    return scroll;
                }
            };
            pop.setBorder(new LineBorder(new Color(51, 51, 51), 1));
            return pop;
        }
